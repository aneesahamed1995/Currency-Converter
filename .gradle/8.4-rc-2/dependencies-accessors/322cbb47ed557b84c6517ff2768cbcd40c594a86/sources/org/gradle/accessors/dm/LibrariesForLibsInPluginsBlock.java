...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Deprecated
        ...
        /**
         * Creates a dependency provider for datatheorom (com.datatheorem.android.trustkit:trustkit)
         * This dependency was declared in catalog libs.versions.toml
     * @deprecated Will be removed in Gradle 9.0.
         */
    @Deprecated
        public Provider<MinimalExternalModuleDependency> getDatatheorom() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("datatheorom");
    }
    ...
    public static class ViewmodelLibraryAccessors extends SubDependencyFactory {
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("viewmodel.savedstate");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final Khttp3VersionAccessors vaccForKhttp3VersionAccessors = new Khttp3VersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: agp (8.3.0-alpha07)
            ...
            /**
             * Returns the version associated to this alias: datatheorom (1.1.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getDatatheorom() { return getVersion("datatheorom"); }
            ...
            /**
             * Returns the version associated to this alias: livedata (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: preference (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.khttp3
         */
        public Khttp3VersionAccessors getKhttp3() {
            return vaccForKhttp3VersionAccessors;
        }
    ...
    public static class Khttp3VersionAccessors extends VersionFactory  {

        private final Khttp3LoggingVersionAccessors vaccForKhttp3LoggingVersionAccessors = new Khttp3LoggingVersionAccessors(providers, config);
        public Khttp3VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.khttp3.logging
         */
        public Khttp3LoggingVersionAccessors getLogging() {
            return vaccForKhttp3LoggingVersionAccessors;
        }

    }

    public static class Khttp3LoggingVersionAccessors extends VersionFactory  {

        public Khttp3LoggingVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: khttp3.logging.interceptor (5.0.0-alpha.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getInterceptor() { return getVersion("khttp3.logging.interceptor"); }

    }

    public static class KoinVersionAccessors extends VersionFactory  {

        private final KoinAndroidVersionAccessors vaccForKoinAndroidVersionAccessors = new KoinAndroidVersionAccessors(providers, config);
        public KoinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: koin.core (3.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCore() { return getVersion("koin.core"); }

        /**
         * Returns the group of versions at versions.koin.android
         */
        public KoinAndroidVersionAccessors getAndroid() {
            return vaccForKoinAndroidVersionAccessors;
        }

    }

    public static class KoinAndroidVersionAccessors extends VersionFactory  {

        public KoinAndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: koin.android.version (3.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("koin.android.version"); }
    ...
    public static class LifecycleVersionAccessors extends VersionFactory  {
        ...
        public LifecycleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lifecycle.runtime (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRuntime() { return getVersion("lifecycle.runtime"); }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        private final NavigationSafeVersionAccessors vaccForNavigationSafeVersionAccessors = new NavigationSafeVersionAccessors(providers, config);
        private final NavigationUiVersionAccessors vaccForNavigationUiVersionAccessors = new NavigationUiVersionAccessors(providers, config);
         ...
         */
        public NavigationFragmentVersionAccessors getFragment() {
            return vaccForNavigationFragmentVersionAccessors;
        }

        /**
         * Returns the group of versions at versions.navigation.safe
         */
        public NavigationSafeVersionAccessors getSafe() {
            return vaccForNavigationSafeVersionAccessors;
        }

        /**
         * Returns the group of versions at versions.navigation.ui
         */
        public NavigationUiVersionAccessors getUi() {
            return vaccForNavigationUiVersionAccessors;
        }
    ...
    public static class NavigationFragmentVersionAccessors extends VersionFactory  {
        ...
        public NavigationFragmentVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigation.fragment.ktx (2.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class NavigationSafeVersionAccessors extends VersionFactory  {
        ...
        public NavigationSafeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.navigation.safe.args
         */
        public NavigationSafeArgsVersionAccessors getArgs() {
    ...
    public static class NavigationSafeArgsVersionAccessors extends VersionFactory  {
        ...
        private final NavigationSafeArgsGradleVersionAccessors vaccForNavigationSafeArgsGradleVersionAccessors = new NavigationSafeArgsGradleVersionAccessors(providers, config);
        public NavigationSafeArgsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.navigation.safe.args.gradle
         */
        public NavigationSafeArgsGradleVersionAccessors getGradle() {
            return vaccForNavigationSafeArgsGradleVersionAccessors;
        }

    }

    public static class NavigationSafeArgsGradleVersionAccessors extends VersionFactory  {

        public NavigationSafeArgsGradleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: navigation.safe.args.gradle.plugin (2.5.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPlugin() { return getVersion("navigation.safe.args.gradle.plugin"); }

    }

    public static class NavigationUiVersionAccessors extends VersionFactory  {

        public NavigationUiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: navigation.ui.ktx (2.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("navigation.ui.ktx"); }

    }

    public static class ViewmodelVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public ViewmodelVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: viewmodel (2.6.1)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("viewmodel"); }

            /**
             * Returns the version associated to this alias: viewmodel.savedstate (2.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSavedstate() { return getVersion("viewmodel.savedstate"); }
    ...
    public static class NavigationPluginAccessors extends PluginFactory {
        ...
        public NavigationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for navigation.safeargs to the plugin id 'androidx.navigation.safergs'
             * This plugin was declared in catalog libs.versions.toml
             */
