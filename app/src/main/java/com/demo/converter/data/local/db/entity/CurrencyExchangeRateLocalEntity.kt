...
data class CurrencyExchangeRateLocalEntity(
    @ColumnInfo(DbConstant.ExchangeRateTableColumn.BASE_CURRENCY_CODE) var baseCurrencyCode: String = AppConstant.EMPTY,
    @ColumnInfo(DbConstant.ExchangeRateTableColumn.CURRENCY_CODE) var currencyCode: String = AppConstant.EMPTY,
    @ColumnInfo(DbConstant.ExchangeRateTableColumn.EXCHANGE_RATE) var exchangeRate: Double = 0.0
){
    @Ignore var name:String = AppConstant.EMPTY
}
...
data class CurrencyExchangeRateWithNameEntity(
    ...
    @ColumnInfo(DbConstant.ExchangeRateTableColumn.CURRENCY_CODE) var currencyCode: String = AppConstant.EMPTY,
    @ColumnInfo(DbConstant.ExchangeRateTableColumn.EXCHANGE_RATE) var exchangeRate: Double = 0.0,
    @ColumnInfo(DbConstant.CurrencyTableColumn.NAME) var name:String = AppConstant.EMPTY
)
